...
export default function LoginScreen() {
  ...
  async function handleSignIn() {
    ...
    try {
      ...
      router.replace({
        pathname: '/dashboard',
        params: { name: user.displayName, username: user.username },
      });
    } finally {
      setSubmitting(false);
    }
  ...
  const errorMessage = error && <Text style={styles.errorText}>{error}</Text>;
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.card}>
            ...
            <View style={styles.demoBlock}>
              ...
              <Text style={styles.demoLine}>UserIlocos (Ilocos Norte 1st District Engineering Office)</Text>
              <Text style={styles.demoLine}>UserCebu (Cebu City District Engineering Office)</Text>
